...
class RFIDCardRepository:
    @staticmethod
    def find_by_all_attributes(device_id: str, api_key: str, room_id: int, rfid_uid: str) -> Optional[RFIDCard]:
        """
        ...
        try:
            rfid_card = RFIDCardModel.get(
                ...
                (RFIDCardModel.rfid_uid == rfid_uid)
            )
            return RFIDCard(
    ...
    @staticmethod
    def create(device_id: str, api_key: str, room_id: int, rfid_uid: str) -> RFIDCard:
    ...
    def get_or_create_test_rfid() -> RFIDCard:
        ...
        rfid_uid = f"rfid_test_{device_id[:8]}"
